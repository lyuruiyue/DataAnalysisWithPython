...
* Calculate the total votes of each state and how many votes Trump got from each state
...
* Calculate the percentage of 6 types of jobs in each county of that state
* Create one bar chart display the jobs occupations in the county that Trump has the highest votes
![image](https://github.com/lyuruiyue/DataAnalysisWithPython/raw/master/Final/Analysis3/Work_Occupation_in_WY.PNG)
* Create the other bar chart display the jobs occupations in the county that Hillary has the highest votes
...
* Create a dateframe to store the data of percentage of each race
...
* Create bar chart to display the race percentage in each state 
